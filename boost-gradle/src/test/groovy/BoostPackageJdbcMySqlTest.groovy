...
public class BoostPackageJdbcMySqlTest extends AbstractBoostTest {

    static File resourceDir = new File("build/resources/test/test-jdbc")
    static File testProjectDir = new File(integTestDir, "BoostPackageJdbcMySqlTest")
    static String buildFilename = "mysql.gradle"
    ...
    private static final String MYSQL_JAR = "build/wlp/usr/servers/BoostServer/resources/mysql-connector-java-8.0.15.jar";
    ...
    @Test 
    public void testMySQLVersion() throws IOException {
    
        File targetFile = new File(testProjectDir, MYSQL_JAR)
        assertTrue(targetFile.getCanonicalFile().toString() + "does not exist.", targetFile.exists())
