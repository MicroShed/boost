...
public class BoostPackageJPA22Test extends AbstractBoostTest {
    ...
    public static void setup() {
        ...
        testProjectDir = new File(integTestDir, "BoostPackageJPA22Test")
        buildFilename = "testJPA22.gradle"
    ...
    public void testPackageContents() throws IOException {
        testFeatureInServerXML(JPA_22_FEATURE);
    }
