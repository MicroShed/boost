...
public class BoostPackageJdbcDerbyDefinedTest extends AbstractBoostTest {

    static File resourceDir = new File("build/resources/test/test-jdbc")
    static File testProjectDir = new File(integTestDir, "BoostPackageJdbcDerbyDefinedTest")
    static String buildFilename = "derby-defined.gradle"
    ...
    private static final String DERBY_JAR = "build/wlp/usr/servers/BoostServer/resources/derby-10.11.1.1.jar";
    ...
    @Test 
    public void testDerbyVersion() throws IOException {
    
        File targetFile = new File(testProjectDir, DERBY_JAR)
        assertTrue(targetFile.getCanonicalFile().toString() + "does not exist.", targetFile.exists())
