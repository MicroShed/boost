...
public class BoostDebugMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        // Check our runtime and execute maven goal for either liberty-debug or
        // wildfly-debug

        executeMojo(
                plugin(groupId("io.openliberty.boost"), artifactId("boost-maven-plugin"), version("0.1.3-SNAPSHOT")),
                goal("liberty-debug"), configuration(), executionEnvironment(project, session, pluginManager));
    }
