...
public class MPMetricsBoosterTest {
    ...
    public void testMPMetricsBoosterFeature11() throws Exception {
        ...
        LibertyMPMetricsBoosterConfig libMPMetricsConfig = new LibertyMPMetricsBoosterConfig(BoosterUtil.createDependenciesWithBoosterAndVersion(LibertyMPMetricsBoosterConfig.class, "1.1.0.M1-SNAPSHOT"), logger);
