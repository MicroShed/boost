...
public class MPHealthBoosterTest {
     ...
     * MPHealth booster version is set to 1.0-M1-SNAPSHOT
     * 
     */
    @Test
     ...
     * MPHealth booster version is set to 2.0-1.0-M1-SNAPSHOT
     * 
     */
    @Test
    public void testMPHealthBoosterFeature20() throws Exception {
        ...
        Map<String, String> dependencies = BoosterUtil
                .createDependenciesWithBoosterAndVersion(LibertyMPHealthBoosterConfig.class, "2.0-1.0-M1-SNAPSHOT");
