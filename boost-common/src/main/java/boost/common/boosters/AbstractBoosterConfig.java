...
public abstract class AbstractBoosterConfig {
    ...
    public static final String MP_HEALTH_VERSION_20 = "2.0-" + boostVersion + "-" + milestone + "-SNAPSHOT";
    ...
    public static final String MP_METRICS_VERSION_20 = "2.0-" + boostVersion + "-" + milestone + "-SNAPSHOT";
    ...
    public static final String MP_RESTCLIENT_VERSION_13 = "1.3-" + boostVersion + "-" + milestone + "-SNAPSHOT";
