...
public class MPOpenTracingBoosterTest {
     ...
     */
    @Test
    public void testMPOpenTracingBoosterFeature_MP20() throws Exception {

        LibertyServerConfigGenerator serverConfig = new LibertyServerConfigGenerator(
                outputDir.getRoot().getAbsolutePath(), logger);

        List<AbstractBoosterConfig> boosters = BoosterConfigurator.getBoosterConfigs(
                BoosterUtil.createDependenciesWithBoosterAndVersion(MPOpenTracingBoosterConfig.class, "0.2-SNAPSHOT"),
                logger);
